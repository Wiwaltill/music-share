...
function translate_static_html(string $html): string {
    ...
    if ($language === 'fr') {
        return strtr($html, [
        'Neuestes GitHub-Release' => 'Dernière release GitHub',
        'Die Installation ist aktuell.' => 'L’installation est à jour.',
        'Albumdaten speichern' => 'Enregistrer les informations de l’album',
        'Administratoren – Haben automatisch Zugriff' => 'Administrateurs – Accès automatique',
        'Administratoren - Haben automatisch Zugriff' => 'Administrateurs - Accès automatique',
        'z. B. Kunde / Veranstaltung' => 'p. ex. client / événement',
        'Backups und Rollback' => 'Sauvegardes et restauration',
        'Vor Updates und Wiederherstellungen wird automatisch gesichert.' => 'Une sauvegarde est créée automatiquement avant les mises à jour et restaurations.',
        'Noch keine Backups vorhanden.' => 'Aucune sauvegarde disponible.',
        'Update-Schutz' => 'Protection des mises à jour',
        'Jetzt prüfen' => 'Vérifier maintenant',
        'Neue Versionen direkt aus den GitHub-Releases installieren.' => 'Installer les nouvelles versions directement depuis les releases GitHub.',
        'Migration und vollständige Datensicherung' => 'Migration et sauvegarde complète',
        'Backup von einer anderen Instanz hochladen' => 'Téléverser une sauvegarde d’une autre instance',
        'Noch keine Migrationsbackups vorhanden.' => 'Aucune sauvegarde de migration disponible.',
        'ZIP hochladen und prüfen' => 'Téléverser et vérifier le ZIP',
        'Der Trash ist leer.' => 'La corbeille est vide.',
        'Papierkorb ist leer.' => 'La corbeille est vide.',
        'Datei auswählen' => 'Choisir un fichier',
        'Keine Datei ausgewählt' => 'Aucun fichier sélectionné',
        'Musikalben hochladen, gestalten und teilen.' => 'Téléversez, présentez et partagez des albums musicaux.',
        'Keine Alben für diese Suche gefunden.' => 'Aucun album trouvé pour cette recherche.',
        'Getaggtes Album direkt hochladen' => 'Téléverser directement un album balisé',
        'Wähle vollständig getaggte MP3-Dateien. Album, Cover, CDs und Reihenfolge werden automatisch vorbereitet.' => 'Sélectionnez des fichiers MP3 entièrement balisés. L’album, la pochette, les disques et l’ordre sont préparés automatiquement.',
        'Album direkt hochladen' => 'Téléverser directement un album',
        'Neues Album' => 'Nouvel album',
        'Eigenes Album' => 'Mon album',
        'Fremdes Album' => 'Album d’un autre utilisateur',
        'Erstellt von' => 'Créé par',
        'Album ansehen' => 'Voir l’album',
        'Vorschau' => 'Aperçu',
        'Verwalten' => 'Gérer',
        'Album verwalten' => 'Gérer l’album',
        'Metadaten, Titel und Freigaben an einem Ort.' => 'Métadonnées, pistes et partages au même endroit.',
        'Zuerst Albumdaten und Cover anlegen.' => 'Créez d’abord les informations de l’album et la pochette.',
        'Albumtitel' => 'Titre de l’album',
        'Interpret' => 'Artiste',
        'Album Artist' => 'Artiste de l’album',
        'Beschreibung' => 'Description',
        'Erscheinungsjahr' => 'Année de sortie',
        'Cover löschen' => 'Supprimer la pochette',
        'Cover auswählen' => 'Choisir une pochette',
        'Titel hochladen' => 'Téléverser des pistes',
        'Neue Titel hochladen' => 'Téléverser de nouvelles pistes',
        'Dateien hierher ziehen oder auswählen.' => 'Déposez les fichiers ici ou sélectionnez-les.',
        'CDs und Reihenfolge' => 'Disques et ordre',
        'CD hinzufügen' => 'Ajouter un disque',
        'Alle Titel auswählen' => 'Sélectionner toutes les pistes',
        'Ausgewählte löschen' => 'Supprimer la sélection',
        'Interne Mitverwaltung' => 'Collaborateurs internes',
        'Nutzer ohne Zugriff' => 'Utilisateurs sans accès',
        'bereits berechtigt' => 'a déjà accès',
        'Zugriff hinzufügen' => 'Ajouter l’accès',
        'Freigabelinks' => 'Liens de partage',
        'Bezeichnung' => 'Libellé',
        'Optionales Passwort' => 'Mot de passe facultatif',
        'Neues Passwort' => 'Nouveau mot de passe',
        'Passwort unverändert lassen' => 'Conserver le mot de passe actuel',
        'Ablaufdatum' => 'Date d’expiration',
        'Downloads erlauben' => 'Autoriser les téléchargements',
        'Freigabe erstellen' => 'Créer un partage',
        'Freigabe speichern' => 'Enregistrer le partage',
        'Link kopieren' => 'Copier le lien',
        'Unbegrenzt' => 'Illimité',
        'Läuft heute ab' => 'Expire aujourd’hui',
        'läuft heute ab' => 'expire aujourd’hui',
        'Abgelaufen' => 'Expiré',
        'Gefahrenbereich' => 'Zone dangereuse',
        'Album in den Papierkorb verschieben' => 'Déplacer l’album vers la corbeille',
        ...
        'Albumfarben aus dem Cover auf öffentlichen Seiten verwenden' => 'Utiliser les couleurs de la pochette sur les pages publiques',
        'Benutzerverwaltung' => 'Gestion des utilisateurs',
        'Benutzer hinzufügen' => 'Ajouter un utilisateur',
        'Benutzername' => 'Nom d’utilisateur',
        'Anzeigename' => 'Nom affiché',
        'Passwort' => 'Mot de passe',
        'Rolle' => 'Rôle',
        'Nutzer' => 'Utilisateur',
        'Benutzer anlegen' => 'Créer l’utilisateur',
        'Unverändert lassen' => 'Laisser inchangé',
        'Aktiv' => 'Actif',
        'Benutzer löschen' => 'Supprimer l’utilisateur',
        'Erstellt:' => 'Créé :',
        'Updates und Backups' => 'Mises à jour et sauvegardes',
        'Updates' => 'Mises à jour',
        'Installierte Version' => 'Version installée',
        'Verfügbare Version' => 'Version disponible',
        ...
        'Migrationsbackup erstellen' => 'Créer une sauvegarde de migration',
        'Migrationsbackup hochladen' => 'Téléverser une sauvegarde de migration',
        ...
        'Schließen' => 'Fermer',
        'Bearbeiten' => 'Modifier',
        'Album herunterladen' => 'Télécharger l’album',
        'Teilen' => 'Partager',
        'Gesamtlaufzeit' => 'Durée totale',
        'Keine Alben vorhanden.' => 'Aucun album disponible.',
        'Keine gelöschten Alben vorhanden.' => 'Aucun album supprimé.',
        'Album nicht gefunden.' => 'Album introuvable.',
        'Keine Berechtigung.' => 'Accès refusé.',
        'MP3-Dateien auswählen' => 'Sélectionner des fichiers MP3',
        'MP3-Dateien hierher ziehen und ablegen' => 'Glissez-déposez les fichiers MP3 ici',
        ]);
    }
return strtr($html, [
